            ...
            <div class="box-1">
                ...
                <div class="nominados-grid5 contenedor">
                    <div class="item-grid" id="1">
                        <img src="build/img/beat/NOMINADOS INDIVIDUALES-BEAT4LIKE-01.webp" alt="">
                        <div class="item-hover" id="hover-1">
                            <p>Ingratax</p>
                        </div>
                    </div>
                    <div class="item-grid" id="2">
                        <img src="build/img/beat/NOMINADOS INDIVIDUALES-BEAT4LIKE-04.webp" alt="">
                        <div class="item-hover" id="hover-2">
                            <p>Mont Pantoja</p>
                        </div>
                    </div>
                    <div class="item-grid" id="3">
                        <img src="build/img/beat/NOMINADOS INDIVIDUALES-BEAT4LIKE-05.webp" alt="">
                        <div class="item-hover" id="hover-3">
                            <p>Karol Sevilla</p>
                        </div>
                    </div>
                    <div class="item-grid" id="4">
                        <img src="build/img/beat/NOMINADOS INDIVIDUALES-BEAT4LIKE-02.webp" alt="">
                        <div class="item-hover" id="hover-4">
                            <p>María Becerra</p>
                        </div>
                    </div>
                    <div class="item-grid" id="5">
                        <img src="build/img/beat/NOMINADOS INDIVIDUALES-BEAT4LIKE-03.webp" alt="">
